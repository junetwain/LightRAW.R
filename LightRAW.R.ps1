...
$script:ThumbnailBatchSize = 16
$script:ThumbnailWorkerCount = [Math]::Max(4, [Math]::Min(16, [Environment]::ProcessorCount * 2))
$script:ThumbnailConcurrentLimit = [Math]::Max(64, $script:ThumbnailWorkerCount * 16)
$script:ThumbnailRunspacePool = $null
$script:ThumbnailWorkQueue = New-Object System.Collections.Generic.Queue[object]
$script:ThumbnailInFlight = New-Object System.Collections.Generic.List[object]
$script:ThumbnailResultQueue = New-Object System.Collections.Generic.Queue[object]
$script:ThumbnailPendingSet = New-Object 'System.Collections.Generic.HashSet[string]'
